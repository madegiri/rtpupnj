...
@section('title', $artikel->judul . ' - RTPU PNJ')
    ...
    <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <nav aria-label="breadcrumb" class="mb-4">
                    <ol class="breadcrumb breadcrumb-custom">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('artikel-inovasi.index') }}">Artikel Inovasi</a></li>
                        <li class="breadcrumb-item active">{{ Str::limit($artikel->judul, 40) }}</li>
                    </ol>
                </nav>

                {{-- Meta --}}
                {{-- <span class="card-chip mb-3">Artikel Inovasi</span> --}}
        ...
        <div class="related-section">
            <div class="related-header">
                ...
                <h2 class="section-title mt-1">Artikel Terkait</h2>
            </div>
            <div class="row g-4">
...
/* ─── Content Card (konsisten dengan halaman lain) ─── */
.content-card {
    background: #ffffff;
