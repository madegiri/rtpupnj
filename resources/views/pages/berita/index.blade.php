        ...
        <div class="search-wrapper mb-4">
            <form action="{{ route('berita.index') }}" method="GET">
                <div class="search-box">
                    ...
                    >
                    @if($search)
                        <a href="{{ route('berita.index') }}" class="search-clear">
...
.content-card-thumb {
    width: 100%; height: 190px; overflow: hidden; flex-shrink: 0; position: relative;
}
...
.card-chip {
    ...
    border-radius: 50px; max-width: calc(100% - 1.2rem);
