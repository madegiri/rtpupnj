...
@section('title', $berita->judul . ' - RTPU PNJ')
    ...
    <div class="container">
        <div class="row justify-content">
            <div class="col-lg-12">
                ...
                {{-- Meta --}}
                {{-- <span class="card-chip mb-3">Berita</span> --}}
        ...
        <div class="related-section">
            <div class="related-header">
                ...
                <h2 class="section-title mt-1">Berita Terkait</h2>
            </div>
            <div class="row g-4">
                @foreach($related as $item)
                <div class="col-12 col-sm-6 col-lg-4">
                    <a href="{{ route('berita.show', $item->slug) }}" class="content-card h-100" style="text-decoration:none; color:inherit;">
                        ...
                        <div class="content-card-body">
                            ...
                            <p class="content-card-excerpt">{{ Str::limit(strip_tags($item->isi), 110) }}</p>
                        </div>
                    </a>
                </div>
                @endforeach
