...
@section('title', 'Agriculture Environment - CAINT RTPU PNJ')
        ...
        <div class="page-header mb-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-custom">
                    ...
                    <li class="breadcrumb-item active">Agriculture Environment</li>
                </ol>
            </nav>
            {{-- <span class="section-eyebrow">CAINT</span> --}}
            <h1 class="section-title mt-1">Agriculture Environment</h1>
            <p class="section-subtitle">Produk dan riset CAINT dalam bidang Agriculture Environment.</p>
        </div>
        ...
        <div class="row g-4">
                ...
                <div class="content-card h-100">
                    ...
                    <div class="content-card-body">
                        ...
                        <h6 class="content-card-title">
                            <a href="{{ route('caint.agriculture-environment.show', $produk->slug) }}"
            ...
            <div class="col-12">
                <div class="empty-state">
                    <i class="bi bi-tree"></i>
                    <p>Belum ada produk Agriculture Environment.</p>
                </div>
            </div>
            @endforelse
        </div>
