...
@section('title', 'Green Energy - CAINT RTPU PNJ')
...
<section class="py-5">
    <div class="container">
        ...
        <div class="page-header mb-5">
            ...
            <h1 class="section-title mt-1">Green Energy</h1>
            <p class="section-subtitle">Produk dan riset CAINT dalam bidang Green Energy.</p>
        </div>
        ...
        <div class="row g-4">
                ...
                <div class="content-card h-100">
                    ...
                    <div class="content-card-body">
                        ...
                        <h6 class="content-card-title">
                            <a href="{{ route('caint.green-energy.show', $produk->slug) }}"
            ...
            <div class="col-12">
                <div class="empty-state">
                    <i class="bi bi-lightning-charge"></i>
                    <p>Belum ada produk Green Energy.</p>
                </div>
            </div>
            @endforelse
        </div>
