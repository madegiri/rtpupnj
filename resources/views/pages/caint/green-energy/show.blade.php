...
@section('title', $produk->judul . ' - Green Energy CAINT RTPU PNJ')
    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb breadcrumb-custom">
                ...
                <li class="breadcrumb-item"><a href="{{ route('caint.green-energy.index') }}">Green Energy</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                {{-- Meta --}}
                {{-- <span class="card-chip mb-3">Green Energy</span> --}}
                ...
                <div class="article-hero-img">
                    <span class="card-chip">Green Energy</span>
        ...
        <div class="related-section">
                    ...
                    <div class="content-card h-100">
                        ...
                        <div class="content-card-body">
                            ...
                            <h6 class="content-card-title">
                                <a href="{{ route('caint.green-energy.show', $rel->slug) }}"
            ...
            <div class="text-center mt-4">
                <a href="{{ route('caint.green-energy.index') }}" class="btn-lihat-semua">
                    Lihat Semua Green Energy <i class="bi bi-arrow-right"></i>
                </a>
            </div>
        </div>
        @endif
