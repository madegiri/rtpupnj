...
@section('title', $produk->judul . ' - Healthcare CAINT RTPU PNJ')
    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb breadcrumb-custom">
                ...
                <li class="breadcrumb-item"><a href="{{ route('caint.healthcare.index') }}">Healthcare</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                {{-- Meta --}}
                {{-- <span class="card-chip mb-3">Healthcare</span> --}}
                ...
                <div class="article-hero-img">
                    <span class="card-chip">Healthcare</span>
        ...
        <div class="related-section">
                    ...
                    <div class="content-card h-100">
                        ...
                        <div class="content-card-body">
                            ...
                            <h6 class="content-card-title">
                                <a href="{{ route('caint.healthcare.show', $rel->slug) }}"
            ...
            <div class="text-center mt-4">
                <a href="{{ route('caint.healthcare.index') }}" class="btn-lihat-semua">
                    Lihat Semua Healthcare <i class="bi bi-arrow-right"></i>
                </a>
            </div>
        </div>
        @endif
