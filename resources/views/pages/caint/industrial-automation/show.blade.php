...
@section('title', $produk->judul . ' - Industrial Automation CAINT RTPU PNJ')
    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb breadcrumb-custom">
                ...
                <li class="breadcrumb-item"><a href="{{ route('caint.industrial-automation.index') }}">Industrial Automation</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                {{-- Meta --}}
                {{-- <span class="card-chip mb-3">Industrial Automation</span> --}}
        ...
        <div class="related-section">
                    ...
                    <div class="content-card h-100">
                        ...
                        <div class="content-card-body">
                            ...
                            <h6 class="content-card-title">
                                <a href="{{ route('caint.industrial-automation.show', $rel->slug) }}"
            ...
            <div class="text-center mt-4">
                <a href="{{ route('caint.industrial-automation.index') }}" class="btn-lihat-semua">
                    Lihat Semua Industrial Automation <i class="bi bi-arrow-right"></i>
                </a>
            </div>
        </div>
        @endif
