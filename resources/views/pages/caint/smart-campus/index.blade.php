...
@section('title', 'Smart Campus - CAINT RTPU PNJ')
        ...
        <div class="page-header mb-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-custom">
                    ...
                    <li class="breadcrumb-item active">Smart Campus</li>
                </ol>
            </nav>
            {{-- <span class="section-eyebrow">CAINT</span> --}}
            <h1 class="section-title mt-1">Smart Campus</h1>
            <p class="section-subtitle">Produk dan riset CAINT dalam bidang Smart Campus.</p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-12">
                <div class="empty-state">
                    <i class="bi bi-building"></i>
                    <p>Belum ada produk Smart Campus.</p>
                </div>
            </div>
            @endforelse
        </div>
