...
@section('title', 'CARE - Center for Conversion, Conservation, and Applied Renewable Energy - RTPU PNJ')
    ...
    <div class="container">
        ...
        <div class="page-header mb-5">
            ...
            <h1 class="section-title mt-1">
                Center for Conversion, Conservation, and Applied Renewable Energy
            </h1>
            <p class="section-subtitle">
                <span class="care-abbr">(CARE)</span>
            </p>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                ...
                <div class="article-hero-img">
                    <img src="{{ asset('storage/' . $profil->thumbnail) }}" alt="CARE">
                </div>
                @endif
            </div>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="produk-desc-box">
                    <h5 class="produk-desc-title">
                        <i class="bi bi-building"></i> Tentang CARE
                    </h5>
                ...
                <div class="empty-state">
                    ...
                    <p>Informasi CARE belum tersedia.</p>
                </div>
                @endif
