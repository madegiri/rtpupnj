...
@section('title', 'Pengumuman - RTPU PNJ')
...
<section class="py-5">
    <div class="container">
        ...
        <div class="page-header mb-3">
            ...
            <h1 class="section-title mt-1">Pengumuman</h1>
            <p class="section-subtitle">Pengumuman resmi dari RTPU Politeknik Negeri Jakarta.</p>
        </div>
        ...
        <div class="search-wrapper mb-4">
            <form action="{{ route('pengumuman.index') }}" method="GET">
                <div class="search-box">
                    ...
                    >
                    @if($search)
                        <a href="{{ route('pengumuman.index') }}" class="search-clear">
...
@media (max-width: 575.98px) {
    .announce-card { padding: 1rem; gap: 1rem; }
    .announce-thumb { width: 64px; height: 56px; }
}
</style>
