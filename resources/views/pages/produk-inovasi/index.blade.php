...
@section('title', 'Produk Inovasi - RTPU PNJ')
...
<section class="py-5">
    <div class="container">
        ...
        <div class="page-header mb-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-custom">
                    ...
                    <li class="breadcrumb-item active">Produk Inovasi</li>
                </ol>
            </nav>
        ...
        @if($produkInovasis->hasPages())
        <div class="d-flex justify-content-center mt-5">
            <div class="pagination-wrapper">
                {{ $produkInovasis->links('pagination::bootstrap-5') }}
            </div>
        </div>
        @endif
