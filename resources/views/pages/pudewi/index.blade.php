...
@section('title', 'PUDEWI - Pusat Unggulan Desa Wisata Indonesia - RTPU PNJ')
        ...
        <div class="page-header mb-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-custom">
                    ...
                    <li class="breadcrumb-item active">PUDEWI</li>
                </ol>
            </nav>
            {{-- <span class="section-eyebrow">Pusat Unggulan Teknologi</span> --}}
            <h1 class="section-title mt-1">
                Pusat Unggulan Desa Wisata Indonesia
            </h1>
            <p class="section-subtitle">
                <span class="pudewi-abbr">(PUDEWI)</span>
            </p>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                ...
                <div class="article-hero-img">
                    <img src="{{ asset('storage/' . $profil->thumbnail) }}" alt="PUDEWI">
                </div>
                @endif
            </div>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="produk-desc-box">
                    <h5 class="produk-desc-title">
                        <i class="bi bi-building"></i> Tentang PUDEWI
                    </h5>
                ...
                <div class="empty-state">
                    ...
                    <p>Informasi PUDEWI belum tersedia.</p>
                </div>
                @endif
