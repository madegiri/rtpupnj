...
@section('title', 'Sertifikasi & Pelatihan - RTPU PNJ')
        ...
        <div class="page-header mb-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-custom">
                    ...
                    <li class="breadcrumb-item active">Sertifikasi & Pelatihan</li>
                </ol>
            </nav>
                ...
                <div class="content-card h-100">
                    ...
                    <div class="content-card-body">
                        ...
                        <h6 class="content-card-title">
                            <a href="{{ route('sertifikasi.show', $sertifikasi->slug) }}"
                               >{{ Str::limit($sertifikasi->nama, 55) }}</a>
                        </h6>
                        <p class="content-card-excerpt">{{ Str::limit(html_entity_decode(strip_tags($sertifikasi->deskripsi)), 100) }}</p>
                    </div>
                </div>
            </div>
            @empty
...
.content-card-thumb { width: 100%; height: 190px; overflow: hidden; flex-shrink: 0; }
